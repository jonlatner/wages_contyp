...
\begin{sidewaysfigure}[h!]
    ...
    \resizebox{\textwidth}{!}{\includegraphics{../graphs/graph_descriptives_emp_status.pdf}}
    \label{graph_descriptives_emp_status}
\end{sidewaysfigure}

\begin{sidewaysfigure}[h!]
    \caption{Recode contract type by country (conditional on employed with contract)}
    \resizebox{\textwidth}{!}{\includegraphics{../graphs/graph_descriptives_contyp.pdf}}
    \label{graph_descriptives_contyp}
\end{sidewaysfigure}

\begin{sidewaysfigure}[h!]
    \caption{Recode education by country}
    \resizebox{\textwidth}{!}{\includegraphics{../graphs/graph_descriptives_education.pdf}}
...
\begin{sidewaysfigure}[!h]
    ...
    \resizebox{\textwidth}{!}{\includegraphics{../graphs/graph_epl.pdf}}
    \label{graph_epl}
\end{sidewaysfigure}
...
\begin{sidewaystable}[!h]
    ...
    \centering
    \resizebox{\textwidth}{!}{\input{../tables/descriptives_table_steps_country_full.tex}}
...
\begin{sidewaystable}[!h]
    ...
    \centering
    \resizebox{\textwidth}{!}{\input{../tables/descriptives_unmp_steps_contyp.tex}}
...
\centering
    \input{../support_files/simulation/tables/table_compare_transformed_data_original.tex}
...
\centering
    \resizebox{\textwidth}{!}{\input{../support_files/simulation/tables/table_compare_transformed_data_transformed.tex}}
...
\begin{table}[!h]
    ...
    \centering
    \resizebox{\textwidth}{!}{\input{../support_files/simulation/tables/table_compare_transformed_data_output.tex}}
    \label{table_compare_transformed_data_output}
\end{table}

\begin{sidewaysfigure}[!h]
    \caption{How many individuals experience multiple events?}
    \resizebox{\textwidth}{!}{\includegraphics{../graphs/graph_descriptives_multiple_events_num.pdf}}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\section{Appendix: Simulation exercise}\label{sec:simulation}
\setcounter{figure}{0}    
\setcounter{table}{0}    
\renewcommand*\thetable{\Alph{section}.\arabic{table}}
\renewcommand*\thefigure{\Alph{section}.\arabic{figure}}
...
\begin{table}[!h]
    ...
    \centering
    \resizebox{\textwidth}{!}{\input{../support_files/simulation/tables/table_compare_models_simulation_paper.tex}}
...
\begin{table}[!h]
    ...
    \centering
    \input{../tables/beta_coef_contyp_fe.tex}
...
\begin{table}[!h]
    ...
    \centering
    \input{../tables/beta_coef_contyp_feis.tex}
...
\begin{table}[!h]
    ...
    \centering
    \input{../tables/beta_coef_contyp_afe_t_p.tex}
...
\begin{table}[!h]
    ...
    \centering
    \input{../tables/beta_coef_contyp_afe_p_t.tex}
...
\begin{table}[!h]
    ...
    \centering
    \input{../tables/beta_coef_unmp_afe_u_t.tex}
...
\begin{table}[!h]
    ...
    \centering
    \input{../tables/beta_coef_unmp_afe_u_p.tex}
...
%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
\clearpage
\section{Appendix: Sensitivity to sample selection}\label{sec:sensitivity_sample}
\setcounter{table}{0}
\setcounter{figure}{0}
\renewcommand*\thetable{\Alph{section}.\arabic{table}}
\renewcommand*\thefigure{\Alph{section}.\arabic{figure}}
...
\begin{sidewaysfigure}[h!]
    ...
    \resizebox{\textwidth}{!}{\includegraphics{../graphs/age_16_64/graph_sensitivity_compare_contyp_age.pdf}}
    \label{graph_contyp_age_16_64}
\end{sidewaysfigure}

\begin{sidewaysfigure}
    \caption{Effect of event on wages at point in time (as compared to figure \ref{graph_unmp})}
    \resizebox{\textwidth}{!}{\includegraphics{../graphs/age_16_64/graph_sensitivity_compare_unmp_age.pdf}}
