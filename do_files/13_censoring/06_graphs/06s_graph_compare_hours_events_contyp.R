...
df_censoring_1 <- readRDS(paste0(results,"df_yhat_multiple_events_contyp.rds"))
...
df_censoring_2 <- readRDS(paste0(results,"censoring/df_yhat_multiple_events_contyp.rds"))
...
ggsave(plot=p,paste0(graphs,"graph_sensitivity_compare_contyp_censoring.pdf"), height = 6, width = 9)
