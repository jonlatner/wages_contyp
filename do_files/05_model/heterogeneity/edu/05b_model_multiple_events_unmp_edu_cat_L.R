...
with(subset(df_original,country=="CH"),table(event_u_p_time_pos,edu_cat))
...
country_ann <- c("AU","DE","JP","NE-LISS","UK") # Drop "CH" and "KO" because no individuals with low levels of education who experience a transition from unemployment to temporary
...
saveRDS(df_yhat, file = paste0(results, "df_yhat_multiple_events_unmp_edu_cat_L.rds"))
