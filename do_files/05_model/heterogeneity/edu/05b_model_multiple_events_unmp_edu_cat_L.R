...
with(subset(df_original,country=="JP"),table(event_u_p_time_pos,edu_cat))
...
country_ann <- c("AU","DE","UK") # Drop "JP" "CH" and "KO" because no individuals with low levels of education who experience a transition from unemployment to temporary
