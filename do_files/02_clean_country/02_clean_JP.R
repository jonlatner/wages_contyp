...
write.csv(t, file = paste0(support_files, "descriptives/emp_status_jp.csv"), row.names = FALSE)
...
write.csv(t, file = paste0(support_files, "descriptives/contyp_jp.csv"), row.names = FALSE)
...
write.csv(t, file = paste0(support_files, "descriptives/edu_jp.csv"), row.names = FALSE)
