...
write.csv(t, file = paste0(support_files, "emp_status_ch.csv"), row.names = FALSE)
...
write.csv(t, file = paste0(support_files, "contyp_ch.csv"), row.names = FALSE)
...
write.csv(t, file = paste0(support_files, "edu_ch.csv"), row.names = FALSE)
