...
data_files = "data_files/sample_2_years/"
results = "results/sample_2_years/"
...
df_original <- df_original %>%
        select(country,pid,pidseq,year,age,ln_hourly_wage,unmp,temp,perm,event_u_p_time_pos,event_u_t_time_pos,unemployment_rate)
