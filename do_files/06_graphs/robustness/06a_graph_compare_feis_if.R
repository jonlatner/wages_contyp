...
ggsave(paste0(graphs,"graph_contyp_model_feis_event_t_p.pdf"), height = 5, width = 8, plot = last_plot())
...
ggsave(paste0(graphs,"graph_contyp_model_feis_event_p_t.pdf"), height = 5, width = 8, plot = last_plot())
...
ggsave(paste0(graphs,"graph_contyp_model_feis_event_u_t.pdf"), height = 5, width = 8, plot = last_plot())
...
ggsave(paste0(graphs,"graph_contyp_model_feis_event_u_p.pdf"), height = 5, width = 8, plot = last_plot())
