...
df_sample_6 <- df_sample_5 %>%
  filter(unmp == 1 | (unmp == 0 & (hours >= 20 & hours <= 320)))
...
saveRDS(df_sample_11, file = paste0(data_files, "hours/03a_df_sample.rds"))

df_filter_steps <- rbind(step_0,step_1,step_2,step_3,step_4,step_5,step_6,step_7,step_8)
saveRDS(df_filter_steps, file = paste0(data_files, "hours/3a_df_filter_steps.rds"))
