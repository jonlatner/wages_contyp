...
df_event_t_p <- df_multiple_events %>%
        ...
        select(country, pid, pidseq, year, perm, temp, unmp, event_t_p, event_t_p_year, event_t_p_time) %>%
        group_by(country, pidseq) %>%
        ...
        select(country, pid, pidseq, event_t_p_yes_final)
...
df_event_u_p <- df_multiple_events %>%
        ...
        select(country, pid, pidseq, year, perm, temp, unmp, event_u_p, event_u_p_year, event_u_p_time) %>%
        group_by(country, pidseq) %>%
        ...
        select(country, pid, pidseq, event_u_p_yes_final)
...
df_multiple_events %>% select(pid,pidseq,year,unmp,temp,perm,event_u_p,event_u_p_year,event_u_p_yes,event_u_p_yes_final) %>% filter(pid==101502)
...
df_event_u_t <- df_multiple_events %>%
        ...
        select(country, pid, pidseq, year, perm, temp, unmp, event_u_t, event_u_t_year, event_u_t_time) %>%
        group_by(country, pidseq) %>%
        ...
        select(country, pid, pidseq, event_u_t_yes_final)
...
df_event_p_t <- df_multiple_events %>%
        ...
        select(country, pid, pidseq, year, perm, temp, unmp, event_p_t, event_p_t_year, event_p_t_time) %>%
        group_by(country, pidseq) %>%
        ...
        select(country, pid, pidseq, event_p_t_yes_final)
