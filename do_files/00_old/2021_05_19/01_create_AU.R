...
hilda_raw_data = "panel_data/AU_HILDA/raw_data/R/"
data_files = "projects/mobility/data_files/AU/"
...
for(i in seq_along(letters_seq1)) {
        ...
        # read
        df_x <- readRDS(paste0(hilda_raw_data,"Rperson_",letters_seq1[i],"180c.rds"))
        # append
