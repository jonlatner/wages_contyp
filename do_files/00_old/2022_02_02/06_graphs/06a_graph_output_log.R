...
df_yhat <- readRDS(paste0(results,"df_yhat_hourly_wages_log.rds"))
df_yhat <- df_yhat %>%
...
ggsave(paste0(graphs,"graph_output_log_post_event_temp.pdf"), height = 4, width = 8, plot = last_plot())
...
ggsave(paste0(graphs,"graph_output_log_post_event_unmp.pdf"), height = 4, width = 8, plot = last_plot())
