...
iv_vars_annual = c("event_time_pos_1 + event_time_pos_2 + event_time_pos_3 + event_time_pos_4 + event_time_pos_5 + event_time_pos_6 + event_time_pos_7 + event_time_pos_8")
iv_vars_biannual = c("event_time_pos_1 + event_time_pos_3 + event_time_pos_5 + event_time_pos_7 + event_time_pos_8")
...
for(c in country) {
        ...
        for (e in event) {
                ...
                vars <- c(iv_vars_biannual,year_vars)
...
for(c in country) {
        ...
        for (e in event) {
                ...
                # create independent variables
                vars <- c(iv_vars_annual,year_vars)
...
for(c in country) {
        ...
        model_event_1_country <- get(paste0("model_event_1_country_",c))
        model_event_2_country <- get(paste0("model_event_2_country_",c))
        model_event_3_country <- get(paste0("model_event_3_country_",c))
        model_event_4_country <- get(paste0("model_event_4_country_",c))
        
        texreg(list(model_event_1_country,model_event_4_country,model_event_2_country,model_event_3_country),
               custom.model.names = c("Event 1 (T-P)", "Event 4 (P-T)", "Event 2 (U-P)", "Event 3 (U-T)"),
               custom.coef.names = c("Pre event (-2)", "Pre event (-1)", "Event", "Post event (+1)", "Post event (+2)", "Post event (+3)", "Post event (+4)", "Post event ($>=5$)"),
               file = paste0(tables,"table_model_output_country_",c,".tex"),
               table = FALSE,
...
for(c in country) {
        ...
        texreg(list(model_event_1_country,model_event_4_country,model_event_2_country,model_event_3_country),
               custom.model.names = c("Event 1 (T-P)", "Event 4 (P-T)", "Event 2 (U-P)", "Event 3 (U-T)"),
               custom.coef.names = c("Pre event (-2)", "Event", "Post event (+2)", "Post event (+4)", "Post event ($>=6$)"),
               file = paste0(tables,"table_model_output_country_",c,".tex"),
               table = FALSE,
               include.rsquared = TRUE, include.adjrs = FALSE,include.nobs = FALSE,include.rmse=FALSE,include.groups=FALSE,
               omit.coef = c("year"))
...
for (e in event) {
        ...
        texreg(list(model_AU,model_CH,model_DE,model_JP,model_KO,`model_NE-LISS`,model_UK,`model_NE-LSP`,model_IT),
               ...
               custom.coef.names = c("Pre event (-2)", "Pre event (-1)", "Event", "Post event (+1)", "Post event (+2)", "Post event (+3)", "Post event (+4)", "Post event ($>=5$)"),
               file = paste0(tables,"table_model_output_event_",e,".tex"),
               table = FALSE,
               include.rsquared = TRUE, include.adjrs = FALSE,include.nobs = FALSE,include.rmse=FALSE,include.groups=FALSE,
               omit.coef = c("year"))
}
...
newdata_neg_2 = data.frame(event_time_pos_1=1,event_time_pos_2=0, # pre event
...
newdata_neg_1 = data.frame(event_time_pos_1=0,event_time_pos_2=1, # pre event
                           event_time_pos_3=0, # event
                           event_time_pos_4=0,event_time_pos_5=0,event_time_pos_6=0,event_time_pos_7=0,event_time_pos_8=0, # post event
                           year2001=0,year2002=0,year2003=0,year2004=0,year2005=0,year2006=0,year2007=0,year2008=0,year2009=0,year2010=0,
                           year2011=0,year2012=0,year2013=0,year2014=0,year2015=0,year2016=0,year2017=0,year2018=0
...
newdata_0 = data.frame(event_time_pos_1=0,event_time_pos_2=0, # pre event
...
newdata_pos_1 = data.frame(event_time_pos_1=0,event_time_pos_2=0, # pre event
                           event_time_pos_3=0, # event
...
newdata_pos_2 = data.frame(event_time_pos_1=0,event_time_pos_2=0, # pre event
                           event_time_pos_3=0, # event
...
newdata_pos_3 = data.frame(event_time_pos_1=0,event_time_pos_2=0, # pre event
                           event_time_pos_3=0, # event
...
newdata_pos_4 = data.frame(event_time_pos_1=0,event_time_pos_2=0, # pre event
                           event_time_pos_3=0, # event
...
newdata_neg_2 = data.frame(event_time_pos_1=1, # pre event
                           event_time_pos_3=0, # event
                           event_time_pos_4=0,event_time_pos_5=0,event_time_pos_6=0,event_time_pos_7=0,event_time_pos_8=0, # post event
                           year2001=0,year2002=0,year2003=0,year2004=0,year2005=0,year2006=0,year2007=0,year2008=0,year2009=0,year2010=0,
                           year2011=0,year2012=0,year2013=0,year2014=0,year2015=0,year2016=0,year2017=0,year2018=0
...
ggsave(paste0(graphs,"graph_model_output_event_1_4.pdf"), height = 4, width = 8, plot = last_plot())
...
ggsave(paste0(graphs,"graph_model_output_event_2_3.pdf"), height = 4, width = 8, plot = last_plot())
...
ggsave(paste0(graphs,"graph_model_output_event_2_3_post_event.pdf"), height = 4, width = 8, plot = last_plot())
