...
df_sample_1 <- df_sample_0 %>%
        ...
        select(country,pid,year,ln_hourly_wage,unmp,temp,matches("event_2"))
...
for(c in country) {
        ...
        df_dummy <- dummy(x = df_country$post_event_2,sep = "_")
        ...
        yhat_neg_1 <- data.frame(predict(object = model,
                                         se.fit = TRUE,
                                         newdata = data.frame(pre_event_2=1,
                                                              event_2=0,
        ...
        yhat_0 <- data.frame(predict(object = model,
                                     se.fit = TRUE,
                                     newdata = data.frame(pre_event_2=0,
                                                          event_2=1,
                                                          post_event_2_1=0,post_event_2_2=0,post_event_2_3=0,post_event_2_4=0,post_event_2_5=0,
                                                          year2001=0,year2002=0,year2003=0,year2004=0,year2005=0,year2006=0,year2007=0,year2008=0,year2009=0,year2010=0,
                                                          year2011=0,year2012=0,year2013=0,year2014=0,year2015=0,year2016=0,year2017=0,year2018=0
...
iv_vars = c("pre_event_2",
            "event_2", 
            "post_event_2_1", "post_event_2_2", "post_event_2_3"
)
country <- c("IT","NE-LSP")
for(c in country) {
        print(c)
        ...
        # create year variables
        df_country <- df_country %>%
                mutate(post_event_2 = ifelse(post_event_2 > 3, yes = 3, no = post_event_2))
...
write.csv(df_model_yhat,file = paste0(results,"yhat_event_2.csv"))
