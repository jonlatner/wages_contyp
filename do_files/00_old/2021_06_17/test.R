...
filter(df_sample_1, event_1_yes == 1) %>% select(country,pid,year,unmp,temp,perm,matches("event_1")) %>% print(n=20)
...
filter(df_sample_2, event_2_yes == 1) %>% select(country,pid,year,unmp,temp,perm,matches("event_2")) %>% print(n=40)
...
filter(df_sample_3, event_3_yes == 1) %>% select(country,pid,year,unmp,temp,perm,matches("event_3")) %>% print(n=40)
...
filter(df_sample_4, event_4_yes == 1) %>% select(country,pid,year,unmp,temp,perm,matches("event_4")) %>% print(n=40)
