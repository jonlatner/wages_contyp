...
df_original <- df_original %>%
        select(country,pid,year,age,ln_hourly_wage,unmp,temp,perm,event_u_p_step,event_u_t_step,event_u_p_yes_final,event_u_t_yes_final,event_u_p_time_pos,event_u_t_time_pos,unemployment_rate)
...
for(c in country_bi) {
        ...
        # save(model, file=paste0(results,"model_first_unmp_country_",c,".Rdata"))
...
saveRDS(df_yhat, file = paste0(results, "df_yhat_first_unmp.rds"))
