...
table(df_first_event$event_t_p_time_pos)

df_first_event %>% group_by(event_t_p_time_pos) %>% summarise(mean = mean(ln_hourly_wage))
...
table(df_first_event$event_p_t_time_pos)

df_first_event %>% group_by(event_p_t_time_pos) %>% summarise(mean = mean(ln_hourly_wage))
