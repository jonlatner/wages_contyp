...
ggplot(df_graph, aes(x=count, y=Freq)) +
        ...
        geom_bar(stat="identity")+
        theme_bw() + 
        scale_y_continuous(labels = function(x) format(x, big.mark = "."), limits = c(0,30000)) +
...
ggsave(paste0(graphs,"graph_country_events_yes_no_presentation_num.pdf"), height = 6, width = 9, plot = last_plot())
