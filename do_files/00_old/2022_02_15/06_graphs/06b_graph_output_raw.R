...
df_yhat <- readRDS(paste0(results,"df_yhat_hourly_wages_raw.rds"))
df_yhat <- df_yhat %>%
...
ggsave(paste0(graphs,"graph_output_raw_post_event_temp.pdf"), height = 4, width = 8, plot = last_plot())
...
ggsave(paste0(graphs,"graph_output_raw_post_event_unmp.pdf"), height = 4, width = 8, plot = last_plot())
