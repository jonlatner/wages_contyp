...
df_yhat <- readRDS(paste0(data_files,"df_yhat_first_base_age_unmp.rds"))
...
ggsave(paste0(graphs,"graph_model_3_first_output_country_DE.pdf"), height = 4, width = 8, plot = last_plot())
...
ggsave(paste0(graphs,"graph_model_3_first_output_event_temp.pdf"), height = 4, width = 8, plot = last_plot())
...
ggsave(paste0(graphs,"graph_model_3_first_output_event_unmp.pdf"), height = 4, width = 8, plot = last_plot())
...
ggsave(paste0(graphs,"graph_model_3_first_output_event_unmp_post_event.pdf"), height = 4, width = 8, plot = last_plot())
