...
# Country data
df_au <- readRDS(paste0(data_files, "AU/au_sample_v01.rds")) # all non permanent jobs are temporary
...
# df_sample_3 <- df_sample_3 %>%
#         mutate(age_cat = ifelse(age >= 25 & age < 35, 1,
#                                 ifelse(age >= 35 & age < 50, 2, 
#                                        ifelse(age >= 50 & age <= 60, 3, NA))))
...
# keep if unemployed or employed and hours greater than or equal to 1
...
saveRDS(df_sample_10, file = paste0(data_files, "03a_df_sample.rds"))
