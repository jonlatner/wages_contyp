...
df_event_u_p <- df_original %>%
        ...
        mutate(event_u_p_time = ifelse(event_u_p_time < -2, yes = -3,
...
with(df_event_u_p,table(event_time_pos,event_u_p_yes,useNA = "ifany"))
...
df_event_u_t <- df_original %>%
        ...
        mutate(event_u_t_time = ifelse(event_u_t_time < -2, yes = -3,
...
with(df_event_u_t,table(event_time_pos,event_u_t_yes,useNA = "ifany"))
