...
# Australia should be .36

df_event_t_p_02 <- with(df_event_t_p_02,table(country,count))
df_event_t_p_02 <- data.frame(prop.table(df_event_t_p_02,1))
...
df_event_u_p_02 <- data.frame(prop.table(df_event_u_p_02,1))
...
df_event_p_t_02 <- data.frame(prop.table(df_event_p_t_02,1))
...
df_event_u_t_02 <- data.frame(prop.table(df_event_u_t_02,1))
...
ggsave(paste0(graphs,"graph_country_events_yes_no_presentation_pct.pdf"), height = 6, width = 9, plot = last_plot())
