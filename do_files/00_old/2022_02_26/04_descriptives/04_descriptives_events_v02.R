...
events_t_p <- with(df_events_t_p_02,table(country,event_t_p))
events_t_p
prop.table(events_t_p,1)
...
events_p_t <- with(df_events_p_t_02,table(country,event_p_t))
events_p_t
prop.table(events_p_t,1)
...
rm(events_p_t,events_t_p,events_u_p,events_u_t)
