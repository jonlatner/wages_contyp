...
df_sample_1 <- df_sample_0 %>%
        ...
        select(country,pid,year,ln_hourly_wage,unmp,temp,matches("event_1")) 
...
for(c in country) {
        ...
        df_country <- df_country %>%
                mutate(post_event_1 = ifelse(post_event_1 > 5, yes = 5, no = post_event_1))
        
        df_dummy <- dummy(x = df_country$post_event_1,sep = "_")
        ...
        yhat_neg_1 <- data.frame(predict(object = model,
                                         se.fit = TRUE,
                                         newdata = data.frame(pre_event_1=1,
                                                              event_1=0,
        ...
        yhat_0 <- data.frame(predict(object = model,
                                     se.fit = TRUE,
                                     newdata = data.frame(pre_event_1=0,
                                                          event_1=1,
                                                          post_event_1_1=0,post_event_1_2=0,post_event_1_3=0,post_event_1_4=0,post_event_1_5=0,
                                                          year2001=0,year2002=0,year2003=0,year2004=0,year2005=0,year2006=0,year2007=0,year2008=0,year2009=0,year2010=0,
                                                          year2011=0,year2012=0,year2013=0,year2014=0,year2015=0,year2016=0,year2017=0,year2018=0
...
iv_vars = c("pre_event_1",
            "event_1", 
            "post_event_1_1", "post_event_1_2", "post_event_1_3"
)
...
for(c in country) {
        ...
        # create year variables
        df_country <- df_country %>%
                mutate(post_event_1 = ifelse(post_event_1 > 3, yes = 3, no = post_event_1))
...
# write.csv(df_output,file = paste0(results,"output_event_1.csv"))
write.csv(df_model_yhat,file = paste0(results,"yhat_event_1.csv"))
