...
p <- ggplot(data = df_graph_1, aes(x = period, y = fit, color = study_period, group = study_period)) +
        ...
        scale_colour_gradient(breaks =seq(2000,2014,2),
                              low = "gray90", high = "gray10", 
                              name= "5 year study period, beginning") +
...
cairo_pdf(paste0(graphs,"graph_full_model_1.pdf"), height = 8, width = 6)
grid.draw(OverlappingStripLabels(p))
dev.off()
...
cairo_pdf(paste0(graphs,"graph_full_model_2.pdf"), height = 5, width = 7)
grid.draw(OverlappingStripLabels(p))
dev.off()
...
cairo_pdf(paste0(graphs,"graph_full_model_3.pdf"), height = 5, width = 7)
grid.draw(OverlappingStripLabels(p))
dev.off()
