...
# model data (Italy, Netherlands) ----
# df_IT_2000 <- filter(df_sample_1,country=="IT" & study_period==2000)
# table(df_IT_2000$post_temp)
# table(df_IT_2000$post_temp_2)
...
for(c in country) {
        ...
        for(y in year) {
                ...
                df_period$post_temp <- recode(df_period$post_temp,"3=2")
                df_period$post_temp_2 <- recode(df_period$post_temp_2,"9=4")
                ...
                yhat_age_cat1 <- predict.lm(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 ...
                                                                 post_temp = c(0,1,2),
                                                                 post_temp_2 = c(0,1,4),
                                                                 age_cat1 = 1, age_cat1_temp = 1, age_cat1_post_temp = c(0,1,2), age_cat1_post_temp_2 = c(0,1,4),
                                                                 age_cat3 = 0, age_cat3_temp = 0, age_cat3_post_temp = 0, age_cat3_post_temp_2 = 0,
                                                                 edu_cat1 = 0, edu_cat1_temp = 0, edu_cat1_post_temp = 0, edu_cat1_post_temp_2 = 0,
                                                                 edu_cat3 = 0, edu_cat3_temp = 0, edu_cat3_post_temp = 0, edu_cat3_post_temp_2 = 0,
                                                                 male = 0, male_temp = 0, male_post_temp = 0, male_post_temp_2 = 0,
                ...
                yhat_age_cat3 <- predict.lm(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 ...
                                                                 post_temp_2 = c(0,1,4),
                                                                 age_cat1 = 0, age_cat1_temp = 0, age_cat1_post_temp = 0, age_cat1_post_temp_2 = 0,
                                                                 age_cat3 = 1, age_cat3_temp = 1, age_cat3_post_temp = c(0,1,2), age_cat3_post_temp_2 = c(0,1,4),
                                                                 edu_cat1 = 0, edu_cat1_temp = 0, edu_cat1_post_temp = 0, edu_cat1_post_temp_2 = 0,
                                                                 edu_cat3 = 0, edu_cat3_temp = 0, edu_cat3_post_temp = 0, edu_cat3_post_temp_2 = 0,
                                                                 male = 0, male_temp = 0, male_post_temp = 0, male_post_temp_2 = 0,
                                                                 period2 = 0, period3 = 0, period4 = 0
                ...
                yhat_edu_cat1 <- predict.lm(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 ...
                                                                 age_cat1 = 0, age_cat1_temp = 0, age_cat1_post_temp = 0, age_cat1_post_temp_2 = 0,
                                                                 age_cat3 = 0, age_cat3_temp = 0, age_cat3_post_temp = 0, age_cat3_post_temp_2 = 0,
                                                                 edu_cat1 = 1, edu_cat1_temp = 1, edu_cat1_post_temp = c(0,1,2), edu_cat1_post_temp_2 = c(0,1,4),
                                                                 edu_cat3 = 0, edu_cat3_temp = 0, edu_cat3_post_temp = 0, edu_cat3_post_temp_2 = 0,
                                                                 male = 0, male_temp = 0, male_post_temp = 0, male_post_temp_2 = 0,
                                                                 period2 = 0, period3 = 0, period4 = 0
                                            ))
                ...
                yhat_edu_cat3 <- predict.lm(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 ...
                                                                 age_cat3 = 0, age_cat3_temp = 0, age_cat3_post_temp = 0, age_cat3_post_temp_2 = 0,
                                                                 edu_cat1 = 0, edu_cat1_temp = 0, edu_cat1_post_temp = 0, edu_cat1_post_temp_2 = 0,
                                                                 edu_cat3 = 1, edu_cat3_temp = 1, edu_cat3_post_temp = c(0,1,2), edu_cat3_post_temp_2 = c(0,1,4),
                                                                 male = 0, male_temp = 0, male_post_temp = 0, male_post_temp_2 = 0,
                                                                 period2 = 0, period3 = 0, period4 = 0
                                            ))
                ...
                yhat_male <- predict.lm(object = ols_model, se.fit = TRUE, 
                                        newdata = data.frame(unmp = 0, 
                                                             ...
                                                             edu_cat1 = 0, edu_cat1_temp = 0, edu_cat1_post_temp = 0, edu_cat1_post_temp_2 = 0,
                                                             edu_cat3 = 0, edu_cat3_temp = 0, edu_cat3_post_temp = 0, edu_cat3_post_temp_2 = 0,
                                                             male = 1, male_temp = 1, male_post_temp = c(0,1,2), male_post_temp_2 = c(0,1,4),
                                                             period2 = 0, period3 = 0, period4 = 0
                                        ))
                ...
                yhat_baseline$period <- c(0,2,4)
                yhat_age_cat1$period <- c(0,2,4)
                yhat_age_cat3$period <- c(0,2,4)
                yhat_edu_cat1$period <- c(0,2,4)
                yhat_edu_cat3$period <- c(0,2,4)
                yhat_male$period <- c(0,2,4)
...
df_uk <- filter(df_sample_1,country=="UK")
with(df_uk,table(study_period,year))

df_uk_2000 <- filter(df_uk,study_period==2000)
table(df_uk_2000$post_temp)
table(df_uk_2000$post_temp_2)
...
for(c in country) {
        ...
        for(y in year) {
                ...
                yhat_baseline$period <- c(0,1,2,3)
                yhat_age_cat1$period <- c(0,1,2,3)
                yhat_age_cat3$period <- c(0,1,2,3)
                yhat_edu_cat1$period <- c(0,1,2,3)
                yhat_edu_cat3$period <- c(0,1,2,3)
                yhat_male$period <- c(0,1,2,3)
...
for(c in country) {
        ...
        for(y in year) {
                ...
                yhat_baseline <- predict.lm(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 temp = 1,
                                                                 post_temp = c(0,1,2,3,4),
                                                                 post_temp_2 = c(0,1,4,9,16),
                                                                 age_cat1 = 0, age_cat1_temp = 0, age_cat1_post_temp = 0, age_cat1_post_temp_2 = 0,
                                                                 age_cat3 = 0, age_cat3_temp = 0, age_cat3_post_temp = 0, age_cat3_post_temp_2 = 0,
                                                                 edu_cat1 = 0, edu_cat1_temp = 0, edu_cat1_post_temp = 0, edu_cat1_post_temp_2 = 0,
                                                                 edu_cat3 = 0, edu_cat3_temp = 0, edu_cat3_post_temp = 0, edu_cat3_post_temp_2 = 0,
                                                                 male = 0, male_temp = 0, male_post_temp = 0, male_post_temp_2 = 0,
                                                                 period2 = 0, period3 = 0, period4 = 0, period5 = 0
                                            ))
                ...
                yhat_age_cat1 <- predict.lm(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 ...
                                                                 post_temp = c(0,1,2,3,4),
                                                                 post_temp_2 = c(0,1,4,9,16),
                                                                 age_cat1 = 1, age_cat1_temp = 1, age_cat1_post_temp = c(0,1,2,3,4), age_cat1_post_temp_2 = c(0,1,4,9,16),
                                                                 age_cat3 = 0, age_cat3_temp = 0, age_cat3_post_temp = 0, age_cat3_post_temp_2 = 0,
                                                                 edu_cat1 = 0, edu_cat1_temp = 0, edu_cat1_post_temp = 0, edu_cat1_post_temp_2 = 0,
                                                                 edu_cat3 = 0, edu_cat3_temp = 0, edu_cat3_post_temp = 0, edu_cat3_post_temp_2 = 0,
                                                                 male = 0, male_temp = 0, male_post_temp = 0, male_post_temp_2 = 0,
                ...
                yhat_age_cat3 <- predict.lm(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 ...
                                                                 post_temp_2 = c(0,1,4,9,16),
                                                                 age_cat1 = 0, age_cat1_temp = 0, age_cat1_post_temp = 0, age_cat1_post_temp_2 = 0,
                                                                 age_cat3 = 1, age_cat3_temp = 1, age_cat3_post_temp = c(0,1,2,3,4), age_cat3_post_temp_2 = c(0,1,4,9,16),
                                                                 edu_cat1 = 0, edu_cat1_temp = 0, edu_cat1_post_temp = 0, edu_cat1_post_temp_2 = 0,
                                                                 edu_cat3 = 0, edu_cat3_temp = 0, edu_cat3_post_temp = 0, edu_cat3_post_temp_2 = 0,
                                                                 male = 0, male_temp = 0, male_post_temp = 0, male_post_temp_2 = 0,
                                                                 period2 = 0, period3 = 0, period4 = 0, period5 = 0
                ...
                yhat_edu_cat1 <- predict.lm(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 ...
                                                                 age_cat1 = 0, age_cat1_temp = 0, age_cat1_post_temp = 0, age_cat1_post_temp_2 = 0,
                                                                 age_cat3 = 0, age_cat3_temp = 0, age_cat3_post_temp = 0, age_cat3_post_temp_2 = 0,
                                                                 edu_cat1 = 1, edu_cat1_temp = 1, edu_cat1_post_temp = c(0,1,2,3,4), edu_cat1_post_temp_2 = c(0,1,4,9,16),
                                                                 edu_cat3 = 0, edu_cat3_temp = 0, edu_cat3_post_temp = 0, edu_cat3_post_temp_2 = 0,
                                                                 male = 0, male_temp = 0, male_post_temp = 0, male_post_temp_2 = 0,
                                                                 period2 = 0, period3 = 0, period4 = 0, period5 = 0
                                            ))
                ...
                yhat_edu_cat3 <- predict.lm(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 ...
                                                                 age_cat3 = 0, age_cat3_temp = 0, age_cat3_post_temp = 0, age_cat3_post_temp_2 = 0,
                                                                 edu_cat1 = 0, edu_cat1_temp = 0, edu_cat1_post_temp = 0, edu_cat1_post_temp_2 = 0,
                                                                 edu_cat3 = 1, edu_cat3_temp = 1, edu_cat3_post_temp = c(0,1,2,3,4), edu_cat3_post_temp_2 = c(0,1,4,9,16),
                                                                 male = 0, male_temp = 0, male_post_temp = 0, male_post_temp_2 = 0,
                                                                 period2 = 0, period3 = 0, period4 = 0, period5 = 0
                                            ))
                ...
                yhat_male <- predict.lm(object = ols_model, se.fit = TRUE, 
                                        newdata = data.frame(unmp = 0, 
                                                             ...
                                                             edu_cat1 = 0, edu_cat1_temp = 0, edu_cat1_post_temp = 0, edu_cat1_post_temp_2 = 0,
                                                             edu_cat3 = 0, edu_cat3_temp = 0, edu_cat3_post_temp = 0, edu_cat3_post_temp_2 = 0,
                                                             male = 1, male_temp = 1, male_post_temp = c(0,1,2,3,4), male_post_temp_2 = c(0,1,4,9,16),
                                                             period2 = 0, period3 = 0, period4 = 0, period5 = 0
                                        ))
                ...
                yhat_baseline$period <- c(0,1,2,3,4)
                yhat_age_cat1$period <- c(0,1,2,3,4)
                yhat_age_cat3$period <- c(0,1,2,3,4)
                yhat_edu_cat1$period <- c(0,1,2,3,4)
                yhat_edu_cat3$period <- c(0,1,2,3,4)
                yhat_male$period <- c(0,1,2,3,4)
