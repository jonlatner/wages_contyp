...
for(c in country) {
        ...
        for(y in year) {
                ...
                # model
                ols_model <- lm_robust(as.formula(paste0("ln_hourly_wage ~ ",iv_ols)), cluster = pid,
                                data = df_period)
                ols_model$fitted.values <- NULL
                save(ols_model, file = paste0(results,"ols_model_robust_",c,"_",y,".rda"))
                ...
                #         filter(study_period == y)
                # 
                # plm_model <- plm_robust(as.formula(paste0("ln_hourly_wage ~ ",iv_plm)),
                #                  data = df_period_2,
                #                  index = c("pid","year"))
                # 
                ...
                yhat_baseline <- predict(object = ols_model, se.fit = TRUE, 
                ...
                yhat_age_cat1 <- predict(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 temp = 1,
                                                                 post_temp = c(0,1,2,3),
                                                                 post_temp_2 = c(0,1,4,9),
                ...
                yhat_age_cat3 <- predict(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 temp = 1,
                                                                 post_temp = c(0,1,2,3),
                                                                 post_temp_2 = c(0,1,4,9),
                ...
                yhat_edu_cat1 <- predict(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 temp = 1,
                                                                 post_temp = c(0,1,2,3),
                                                                 post_temp_2 = c(0,1,4,9),
                ...
                yhat_edu_cat3 <- predict(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 temp = 1,
                                                                 post_temp = c(0,1,2,3),
                                                                 post_temp_2 = c(0,1,4,9),
                ...
                yhat_male <- predict(object = ols_model, se.fit = TRUE, 
                                        newdata = data.frame(unmp = 0, 
                                                             temp = 1,
                                                             post_temp = c(0,1,2,3),
                                                             post_temp_2 = c(0,1,4,9),
...
saveRDS(df_model_yhat, file = paste0(results, "results_b_predicted_robust.rds"))
write.csv(df_table_output, file = paste0(results, "results_b_output_robust.csv"))
