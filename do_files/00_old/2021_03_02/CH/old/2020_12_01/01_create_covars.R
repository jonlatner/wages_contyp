...
raw_data = "panel_data/CH_FORS/raw_data/R/"
...
years <- c("99", "00", "01", "02", "03", "04", "05", "06", "07", "08", "09", "10", "11", "12", "13", "14", "15", "16", "17", "18")
years_1 <- c("99", "00", "01")
years_2 <- c("02", "03")
...
vars_ind_1 <- c("idpers", # "idpers" cross-wave person identifier
                ...
                "sex", # "sexXX" gender
                "pw108", # N contractual hours per week
