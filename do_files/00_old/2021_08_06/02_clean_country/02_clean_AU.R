...
data_files = "SECCOPA/projects/mobility/data_files/AU/"
...
df_au$exchange <- df_exchange$exchange
rm(df_exchange)
...
# contract type
df_au$temp  <- recode(df_au$contyp, "lo:0=NA; 1:2=1; 3=0; 8=NA")
...
df_select$country <- "AU"

saveRDS(df_select, file = paste0(data_files, "au_sample.rds"))
