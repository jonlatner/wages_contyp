...
for(c in country) {
        ...
        for(y in year) {
                ...
                model <- feis(ln_hourly_wage ~ 
                                      ...
                                      post_event_1_1 + post_event_1_2 + post_event_1_3 + post_event_1_4 + 
...
for(c in country) {
        ...
        for(y in year) {
                ...
                model <- feis(ln_hourly_wage ~ 
                                      unmp + temp + pre_event_1 + event_1 + 
                                      post_event_1_1 + post_event_1_2 + post_event_1_3 + post_event_1_4 + post_event_1_5 + 
...
df_model_yhat$model <- "event1_feif_post_pre"
df_model_yhat$event <- 1


write.csv(df_output,file = paste0(results,"output_event1_feif_post_pre.csv"))
write.csv(df_model_yhat,file = paste0(results,"yhat_event1_feif_post_pre.csv"))
