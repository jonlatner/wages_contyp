...
for(c in country) {
        ...
        for(y in year) {
                ...
                output$model <- "event2_feis_if_post_pre"
                ...
                yhat_1 <- data.frame(predict(object = model,
                                             ...
                                             newdata = data.frame(unmp=0,temp=1,pre_event_2=0,
                                                                  event_2=1,
                                                                  post_event_2_1=1,post_event_2_2=0,post_event_2_3=0,post_event_2_4=))) %>%
                        select(fit,se.fit)
...
df_model_yhat$model <- "event2_feis_if_post_pre"
df_model_yhat$event <- 2


write.csv(df_output,file = paste0(results,"output_event2_feis_if_post_pre.csv"))
write.csv(df_model_yhat,file = paste0(results,"yhat_event2_feis_if_post_pre.csv"))
