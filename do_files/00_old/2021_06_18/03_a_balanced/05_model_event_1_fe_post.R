...
df_model_yhat$model <- "event1_feif_post"
df_model_yhat$event <- 1

write.csv(df_output, file = paste0(results, "output_event1_feif_post.csv"))
write.csv(df_model_yhat, file = paste0(results, "yhat_event1_feif_post.csv"))
