...
df_sample_1 <- df_sample_0 %>%
        select(country,study_period,pid,year,period,ln_hourly_wage,unmp,temp,event_2a,post_event_2)
...
for(c in country) {
        ...
        for(y in year) {
                ...
                model <- feis(ln_hourly_wage ~ 
                                      unmp + temp + event_2a + 
                                      post_event_2_1 + post_event_2_2 | year, 
                              data = df_period, 
                              id = "pid")
                ...
                output$model <- "event2_feis_if_post"
...
for(c in country) {
        ...
        for(y in year) {
                ...
                model <- feis(ln_hourly_wage ~ 
                                      unmp + temp + event_2a +
                                      post_event_2_1 + post_event_2_2 + post_event_2_3 + post_event_2_4 + post_event_2_5 | year, 
                              data = df_period, 
                              id = "pid")
...
for(c in country) {
        ...
        for(y in year) {
                ...
                model <- feis(ln_hourly_wage ~ 
                                      temp + event_2a + 
                                      post_event_2_1 + post_event_2_2 + post_event_2_3 + post_event_2_4 | year, 
                              data = df_period, 
                              id = "pid")
...
df_model_yhat$model <- "event2_feis_if_post"
df_model_yhat$event <- 2

write.csv(df_output, file = paste0(results, "output_event2_feis_if_post.csv"))
write.csv(df_model_yhat, file = paste0(results, "yhat_event2_feis_if_post.csv"))
