...
# Country data
df_au <- readRDS(paste0(data_files, "UK/uk_sample_v02.rds")) # all non permanent jobs are temporary
...
# (03d_prepare_first_event_data) ----


df_first_event <- df_part_02 %>%
...
saveRDS(df_events_all, file = paste0(data_files, "df_UK_sensitivity.rds"))
