...
ggsave(paste0(graphs,"graph_first_contyp_event.pdf"), height = 4, width = 8, plot = last_plot())
...
ggsave(paste0(graphs,"graph_first_contyp_post.pdf"), height = 4, width = 8, plot = last_plot())
...
ggsave(paste0(graphs,"graph_first_contyp_post_free_scale.pdf"), height = 4, width = 8, plot = last_plot())
