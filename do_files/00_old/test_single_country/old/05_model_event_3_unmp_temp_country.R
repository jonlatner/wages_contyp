...
df_dummy <- dummy(x = df_sample_1$event_3_time_pos,sep = "_")
...
iv_vars_event_3 = c("event_3_time_pos_1 + event_3_time_pos_2 + event_3_time_pos_3 + event_3_time_pos_4 + event_3_time_pos_5 + event_3_time_pos_6 + event_3_time_pos_7 + event_3_time_pos_8")
...
for(c in country) {
        ...
        vars <- c(iv_vars_event_3,year_vars)
        ...
        yhat_neg_1 <- data.frame(predict(object = model,
                                         se.fit = TRUE,
                                         newdata = data.frame(event_3_time_pos_1=1,event_3_time_pos_2=0, # pre event
                                                              event_3_time_pos_3=0, # event
                                                              event_3_time_pos_4=0,event_3_time_pos_5=0,event_3_time_pos_6=0,event_3_time_pos_7=0,event_3_time_pos_8=0, # post event
        ...
        yhat_0 <- data.frame(predict(object = model,
                                     se.fit = TRUE,
                                     newdata = data.frame(event_3_time_pos_1=0,event_3_time_pos_2=0, # pre event
                                                          event_3_time_pos_3=1, # event
                                                          event_3_time_pos_4=0,event_3_time_pos_5=0,event_3_time_pos_6=0,event_3_time_pos_7=0,event_3_time_pos_8=0, # post event
                                                          year2001=0,year2002=0,year2003=0,year2004=0,year2005=0,year2006=0,year2007=0,year2008=0,year2009=0,year2010=0,
                                                          year2011=0,year2012=0,year2013=0,year2014=0,year2015=0,year2016=0,year2017=0,year2018=0
                                     ))) %>%
        ...
        yhat_1 <- data.frame(predict(object = model,
                                     ...
                                     newdata = data.frame(event_3_time_pos_1=0,event_3_time_pos_2=0, # pre event
                                                          event_3_time_pos_3=0, # event
                                                          event_3_time_pos_4=1,event_3_time_pos_5=0,event_3_time_pos_6=0,event_3_time_pos_7=0,event_3_time_pos_8=0, # post event
                                                          year2001=0,year2002=0,year2003=0,year2004=0,year2005=0,year2006=0,year2007=0,year2008=0,year2009=0,year2010=0,
                                                          year2011=0,year2012=0,year2013=0,year2014=0,year2015=0,year2016=0,year2017=0,year2018=0
                                     ))) %>%
                select(fit,se.fit)
        ...
        yhat_2 <- data.frame(predict(object = model,
                                     ...
                                     newdata = data.frame(event_3_time_pos_1=0,event_3_time_pos_2=0, # pre event
                                                          event_3_time_pos_3=0, # event
                                                          event_3_time_pos_4=0,event_3_time_pos_5=1,event_3_time_pos_6=0,event_3_time_pos_7=0,event_3_time_pos_8=0, # post event
                                                          year2001=0,year2002=0,year2003=0,year2004=0,year2005=0,year2006=0,year2007=0,year2008=0,year2009=0,year2010=0,
                                                          year2011=0,year2012=0,year2013=0,year2014=0,year2015=0,year2016=0,year2017=0,year2018=0
                                     ))) %>%
                select(fit,se.fit)
        ...
        yhat_3 <- data.frame(predict(object = model,
                                     ...
                                     newdata = data.frame(event_3_time_pos_1=0,event_3_time_pos_2=0, # pre event
                                                          event_3_time_pos_3=0, # event
                                                          event_3_time_pos_4=0,event_3_time_pos_5=0,event_3_time_pos_6=1,event_3_time_pos_7=0,event_3_time_pos_8=0, # post event
                                                          year2001=0,year2002=0,year2003=0,year2004=0,year2005=0,year2006=0,year2007=0,year2008=0,year2009=0,year2010=0,
                                                          year2011=0,year2012=0,year2013=0,year2014=0,year2015=0,year2016=0,year2017=0,year2018=0
                                     ))) %>%
                select(fit,se.fit)
        ...
        yhat_4 <- data.frame(predict(object = model,
                                     ...
                                     newdata = data.frame(event_3_time_pos_1=0,event_3_time_pos_2=0, # pre event
                                                          event_3_time_pos_3=0, # event
                                                          event_3_time_pos_4=0,event_3_time_pos_5=0,event_3_time_pos_6=0,event_3_time_pos_7=1,event_3_time_pos_8=0, # post event
                                                          year2001=0,year2002=0,year2003=0,year2004=0,year2005=0,year2006=0,year2007=0,year2008=0,year2009=0,year2010=0,
                                                          year2011=0,year2012=0,year2013=0,year2014=0,year2015=0,year2016=0,year2017=0,year2018=0
                                     ))) %>%
                select(fit,se.fit)
