...
df_model_output <- read.csv(paste0(results, "results_output_base_unbalanced.csv")) 
...
# ggsave(paste0(graphs,"graph_model_base_unbalanced.pdf"), height = 5, width = 7, plot = last_plot())
