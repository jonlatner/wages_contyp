...
df_sample_1 <- df_sample_0 %>%
        mutate(edu_cat = ifelse(country == "JP" & edu_cat == 1, yes = 2, no = edu_cat)) %>% # Japan education
        mutate(age_cat = ifelse(country == "CH" & age_cat == 3, yes = 2, no = age_cat)) %>%
        mutate(age_cat = ifelse(country == "CH" & edu_cat == 1, yes = 2, no = age_cat)) # Switzerland education

df_ch <- df_sample_1 %>%
        filter(country == "CH")
with(df_ch, table(temp,age_cat))
with(df_ch, table(post_temp,age_cat))
...
for(c in country) {
        ...
        for(y in year) {
                ...
                vars = c(
                        "unmp", 
                        "temp", "post_temp", "post_temp_sq",
                        "age_cat1_temp", "age_cat1_post_temp", "age_cat1_post_temp_sq",
                        # "age_cat3_temp", "age_cat3_post_temp", "age_cat3_post_temp_sq",
                        # "edu_cat1_temp", "edu_cat1_post_temp", "edu_cat1_post_temp_sq",
                        "edu_cat3_temp", "edu_cat3_post_temp", "edu_cat3_post_temp_sq",
                        "male_temp", "male_post_temp", "male_post_temp_sq", 
                ...
                save(ols_model, file = paste0(results,"ols_model_full_",c,"_",y,".rda"))
                
                # plm model
                # iv_plm <-   "unmp + temp + post_temp + post_temp_sq +
                # temp*as.factor(age_cat) + post_temp*as.factor(age_cat) + post_temp_sq*as.factor(age_cat) +
                # temp*as.factor(edu_cat) + post_temp*as.factor(edu_cat) + post_temp_sq*as.factor(edu_cat) +
                # temp*male + post_temp*male + post_temp_sq*male +
                # factor(period)"
                # 
                ...
                yhat_baseline <- predict.lm(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 ...
                                                                 age_cat1 = 0, age_cat1_temp = 0, age_cat1_post_temp = 0, age_cat1_post_temp_sq = 0,
                                                                 age_cat3 = 0, age_cat3_temp = 0, age_cat3_post_temp = 0, age_cat3_post_temp_sq = 0,
                                                                 edu_cat1 = 0, edu_cat1_temp = 0, edu_cat1_post_temp = 0, edu_cat1_post_temp_sq = 0,
                                                                 edu_cat3 = 0, edu_cat3_temp = 0, edu_cat3_post_temp = 0, edu_cat3_post_temp_sq = 0,
                                                                 male = 0, male_temp = 0, male_post_temp = 0, male_post_temp_sq = 0,
                                                                 period2 = 0, period3 = 0, period4 = 0, period5 = 0, period6 = 0, period7 = 0
                                            ))
                
                yhat_one <- predict.lm(object = ols_model, se.fit = TRUE, 
                                       newdata = data.frame(unmp = 0, 
                                                            temp = 0,
                                                            post_temp = c(2),
                                                            post_temp_sq = c(4),
                ...
                yhat_age_cat1 <- predict.lm(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 ...
                                                                 post_temp = c(0,1,2,3,4,5,6),
                                                                 post_temp_sq = c(0,1,4,9,16,25,36),
                                                                 age_cat1 = 1, age_cat1_temp = 1, age_cat1_post_temp = c(0,1,2,3,4,5,6), age_cat1_post_temp_sq = c(0,1,4,9,16,25,36),
                                                                 age_cat3 = 0, age_cat3_temp = 0, age_cat3_post_temp = 0, age_cat3_post_temp_sq = 0,
                                                                 edu_cat1 = 0, edu_cat1_temp = 0, edu_cat1_post_temp = 0, edu_cat1_post_temp_sq = 0,
                                                                 edu_cat3 = 0, edu_cat3_temp = 0, edu_cat3_post_temp = 0, edu_cat3_post_temp_sq = 0,
                                                                 male = 0, male_temp = 0, male_post_temp = 0, male_post_temp_sq = 0,
                ...
                yhat_edu_cat3 <- predict.lm(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 ...
                                                                 age_cat3 = 0, age_cat3_temp = 0, age_cat3_post_temp = 0, age_cat3_post_temp_sq = 0,
                                                                 edu_cat1 = 0, edu_cat1_temp = 0, edu_cat1_post_temp = 0, edu_cat1_post_temp_sq = 0,
                                                                 edu_cat3 = 1, edu_cat3_temp = 1, edu_cat3_post_temp = c(0,1,2,3,4,5,6), edu_cat3_post_temp_sq = c(0,1,4,9,16,25,36),
                                                                 male = 0, male_temp = 0, male_post_temp = 0, male_post_temp_sq = 0,
                                                                 period2 = 0, period3 = 0, period4 = 0, period5 = 0, period6 = 0, period7 = 0
                                            ))
                ...
                yhat_male <- predict.lm(object = ols_model, se.fit = TRUE, 
                                        newdata = data.frame(unmp = 0, 
                                                             ...
                                                             edu_cat1 = 0, edu_cat1_temp = 0, edu_cat1_post_temp = 0, edu_cat1_post_temp_sq = 0,
                                                             edu_cat3 = 0, edu_cat3_temp = 0, edu_cat3_post_temp = 0, edu_cat3_post_temp_sq = 0,
                                                             male = 1, male_temp = 1, male_post_temp = c(0,1,2,3,4,5,6), male_post_temp_sq = c(0,1,4,9,16,25,36),
                                                             period2 = 0, period3 = 0, period4 = 0, period5 = 0, period6 = 0, period7 = 0
                                        ))
                ...
                yhat_one <- data.frame(as.vector(yhat_one))
                yhat_one$variable <- "one"
                yhat_one$period <- c(2)
                
                yhat <- data.frame(rbind(yhat_baseline,yhat_one,yhat_age_cat1,yhat_edu_cat3,yhat_male))
                yhat$study_period = y
                yhat$country = c
                
                df_model_yhat <- rbind(df_model_yhat,yhat)
                
                rm(yhat_baseline,yhat_one,yhat_age_cat1,yhat_edu_cat3,yhat_male,yhat)
        ...
        for(y in year) {
                ...
                yhat_age_cat1 <- predict.lm(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 ...
                                                                 post_temp = c(0,1,2,3),
                                                                 post_temp_sq = c(0,1,4,9),
                                                                 age_cat1 = 1, age_cat1_temp = 1, age_cat1_post_temp = c(0,1,2,3), age_cat1_post_temp_sq = c(0,1,4,9),
                                                                 age_cat3 = 0, age_cat3_temp = 0, age_cat3_post_temp = 0, age_cat3_post_temp_sq = 0,
                                                                 edu_cat1 = 0, edu_cat1_temp = 0, edu_cat1_post_temp = 0, edu_cat1_post_temp_sq = 0,
                                                                 edu_cat3 = 0, edu_cat3_temp = 0, edu_cat3_post_temp = 0, edu_cat3_post_temp_sq = 0,
                                                                 male = 0, male_temp = 0, male_post_temp = 0, male_post_temp_sq = 0,
                ...
                yhat_age_cat3 <- predict.lm(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 ...
                                                                 post_temp_sq = c(0,1,4,9),
                                                                 age_cat1 = 0, age_cat1_temp = 0, age_cat1_post_temp = 0, age_cat1_post_temp_sq = 0,
                                                                 age_cat3 = 1, age_cat3_temp = 1, age_cat3_post_temp = c(0,1,2,3), age_cat3_post_temp_sq = c(0,1,4,9),
                                                                 edu_cat1 = 0, edu_cat1_temp = 0, edu_cat1_post_temp = 0, edu_cat1_post_temp_sq = 0,
                                                                 edu_cat3 = 0, edu_cat3_temp = 0, edu_cat3_post_temp = 0, edu_cat3_post_temp_sq = 0,
                                                                 male = 0, male_temp = 0, male_post_temp = 0, male_post_temp_sq = 0,
                                                                 period2 = 0, period3 = 0, period4 = 0
                ...
                yhat_edu_cat1 <- predict.lm(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 ...
                                                                 age_cat1 = 0, age_cat1_temp = 0, age_cat1_post_temp = 0, age_cat1_post_temp_sq = 0,
                                                                 age_cat3 = 0, age_cat3_temp = 0, age_cat3_post_temp = 0, age_cat3_post_temp_sq = 0,
                                                                 edu_cat1 = 1, edu_cat1_temp = 1, edu_cat1_post_temp = c(0,1,2,3), edu_cat1_post_temp_sq = c(0,1,4,9),
                                                                 edu_cat3 = 0, edu_cat3_temp = 0, edu_cat3_post_temp = 0, edu_cat3_post_temp_sq = 0,
                                                                 male = 0, male_temp = 0, male_post_temp = 0, male_post_temp_sq = 0,
                                                                 period2 = 0, period3 = 0, period4 = 0
                                            ))
                ...
                yhat_edu_cat3 <- predict.lm(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 ...
                                                                 age_cat3 = 0, age_cat3_temp = 0, age_cat3_post_temp = 0, age_cat3_post_temp_sq = 0,
                                                                 edu_cat1 = 0, edu_cat1_temp = 0, edu_cat1_post_temp = 0, edu_cat1_post_temp_sq = 0,
                                                                 edu_cat3 = 1, edu_cat3_temp = 1, edu_cat3_post_temp = c(0,1,2,3), edu_cat3_post_temp_sq = c(0,1,4,9),
                                                                 male = 0, male_temp = 0, male_post_temp = 0, male_post_temp_sq = 0,
                                                                 period2 = 0, period3 = 0, period4 = 0
                                            ))
                ...
                yhat_male <- predict.lm(object = ols_model, se.fit = TRUE, 
                                        newdata = data.frame(unmp = 0, 
                                                             ...
                                                             edu_cat1 = 0, edu_cat1_temp = 0, edu_cat1_post_temp = 0, edu_cat1_post_temp_sq = 0,
                                                             edu_cat3 = 0, edu_cat3_temp = 0, edu_cat3_post_temp = 0, edu_cat3_post_temp_sq = 0,
                                                             male = 1, male_temp = 1, male_post_temp = c(0,1,2,3), male_post_temp_sq = c(0,1,4,9),
                                                             period2 = 0, period3 = 0, period4 = 0
                                        ))
                ...
                yhat <- data.frame(rbind(yhat_baseline,yhat_one,yhat_age_cat1,yhat_age_cat3,yhat_edu_cat1,yhat_edu_cat3,yhat_male))
                yhat$study_period = y
                yhat$country = c
                
                df_model_yhat <- rbind(df_model_yhat,yhat)
                
                rm(yhat_baseline,yhat_oneyhat_age_cat1,yhat_age_cat3,yhat_edu_cat1,yhat_edu_cat3,yhat_male,yhat)
...
for(c in country) {
        ...
        for(y in year) {
                ...
                rm(yhat_baseline,yhat_one,yhat_age_cat1,yhat_age_cat3,yhat_edu_cat1,yhat_edu_cat3,yhat_male,yhat)
        ...
        for(y in year) {
                ...
                yhat_age_cat3 <- predict.lm(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 ...
                                                                 post_temp_sq = c(0,1,4,9,16,25,36),
                                                                 age_cat1 = 0, age_cat1_temp = 0, age_cat1_post_temp = 0, age_cat1_post_temp_sq = 0,
                                                                 age_cat3 = 1, age_cat3_temp = 1, age_cat3_post_temp = c(0,1,2,3,4,5,6), age_cat3_post_temp_sq = c(0,1,4,9,16,25,36),
                                                                 edu_cat1 = 0, edu_cat1_temp = 0, edu_cat1_post_temp = 0, edu_cat1_post_temp_sq = 0,
                                                                 edu_cat3 = 0, edu_cat3_temp = 0, edu_cat3_post_temp = 0, edu_cat3_post_temp_sq = 0,
                                                                 male = 0, male_temp = 0, male_post_temp = 0, male_post_temp_sq = 0,
                                                                 period2 = 0, period3 = 0, period4 = 0, period5 = 0, period6 = 0
                ...
                yhat_edu_cat1 <- predict.lm(object = ols_model, se.fit = TRUE, 
                                            newdata = data.frame(unmp = 0, 
                                                                 ...
                                                                 age_cat1 = 0, age_cat1_temp = 0, age_cat1_post_temp = 0, age_cat1_post_temp_sq = 0,
                                                                 age_cat3 = 0, age_cat3_temp = 0, age_cat3_post_temp = 0, age_cat3_post_temp_sq = 0,
                                                                 edu_cat1 = 1, edu_cat1_temp = 1, edu_cat1_post_temp = c(0,1,2,3,4,5,6), edu_cat1_post_temp_sq = c(0,1,4,9,16,25,36),
                                                                 edu_cat3 = 0, edu_cat3_temp = 0, edu_cat3_post_temp = 0, edu_cat3_post_temp_sq = 0,
                                                                 male = 0, male_temp = 0, male_post_temp = 0, male_post_temp_sq = 0,
                                                                 period2 = 0, period3 = 0, period4 = 0, period5 = 0, period6 = 0
                                            ))
...
for(c in country) {
        ...
        for(y in year) {
                ...
                yhat <- data.frame(rbind(yhat_baseline,yhat_one,yhat_age_cat1,yhat_age_cat3,yhat_edu_cat3,yhat_male))
                yhat$study_period = y
                yhat$country = c
